# $Id: /local/CPAN/Mango/lib/Mango/Catalyst/Controller/Settings.pm 1528 2008-04-14T01:08:40.114508Z claco  $
...
BEGIN {
    ...
    __PACKAGE__->config(
        ...
        form_directory =>
          Path::Class::Dir->new( Mango->share, 'forms', 'settings' )
    );
}
...
=head1 SYNOPSIS
    ...
    use base 'Mango::Catalyst::Controller::Settings';
