# ABSTRACT: Mango Application Class and Document Class Controller

use strict;
use warnings;

package Mango::Application;
{
    $Mango::Application::VERSION = '0.001_01';
}
...
Mango::Application - Mango Application Class and Document Class Controller
...
Mango::Application is used to load and configure associated document classes.
It is essentially the application hub (or starting-point). Because all Mango
document classes can have their own database configuration, and thus need to be
setup individually, Mango::Application can be used to bring those individual
classes together to form a single application.

Mango::Application exports the app() method which allows you to configure
your application having the configuration applied to all associated document
classes. Mango::Application will also load all associated classes and make
...
using L<Mango::Document>, please read that documentation towards getting
started. Enjoy!!!
...
all associated document classes. L<Mango::Document> classes are designed so
...
document classes to share a single database connection and Mango::Application
allows you to do that. Mango::Application can also preload specified classes.
Mango::Application also handling connection pooling seamlessly.
...
The config attribute gives you access to the Mango::Application class
