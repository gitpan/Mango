# ABSTRACT: Syntactic Sugar For Defining Mango Document Classes

use strict;
use warnings;

package Mango::Document::Sugar;
{
    $Mango::Document::Sugar::VERSION = '0.001_01';
}
...
sub key {
    ...
    my $old_trigger = $data{trigger};
    $data{trigger} = sub {
        my ($self, $new_value, $old_value) = @_;
        $self->_dirty->{$name} = 1;

        goto &$old_trigger if $old_trigger;
    };
...
Mango::Document::Sugar provides the DSL (domain-specific-language) used to
...
specified by the class attribute with a L<Mango::Document::Relative>
instance. Please read the documentation at L<Mango::Document::Relative> for
...
includes functionality from L<Mango::Document::Config>. You will most likely
...
L<Mango::Document::Child> instance. Please read the documentation at
L<Mango::Document::Child> for more information on using this object.
...
L<Mango::Document::GridFile> instance. Please read the documentation at
L<Mango::Document::GridFile> for more information on using this object.
...
chainable L<Mango::Document::Storage::Criterion> search object which is the
main Mango query abstraction layer. Please see the documentation available
with L<Mango::Document::Storage::Criterion> for more information on querying.
...
for later use by Mango.

The key and has keywords can be used side-by-side ... with the understanding
that the Moose has() method doesn't register a Mango field so when expanding
...
L<Mango::Document::Config> module. The following is an example of that:
