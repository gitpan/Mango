# Base Class for a Mango Document Class

use strict;
use warnings;

package Mango::Document::Base;
{
    $Mango::Document::Base::VERSION = '0.001_01';
}
...
use Moose::Exporter;
use MooseX::Traits;
use Mango::Document::Sugar ();

my ($import, $unimport, $init_meta) = Moose::Exporter->build_import_methods(
    also => ['Moose', 'Mango::Document::Sugar',],
    base_class_roles =>
      ['Mango::Document::Storage', 'Mango::Document::Storage::Operation',],
);
...
sub init_meta {
    ...
    Moose::Util::MetaRole::apply_base_class_roles(
        ...
        roles => [
            'MooseX::Traits',
            'Mango::Document::Storage',
            'Mango::Document::Storage::Operation',
        ]
    );
