# ABSTRACT: A GridFS Wrapper Around Mango File Documents

use strict;
use warnings;

package Mango::Document::GridFile;
{
    $Mango::Document::GridFile::VERSION = '0.001_01';
}
...
Mango::Document::GridFile - A GridFS Wrapper Around Mango File Documents
...
=head1 SYNOPSIS
    ...
    my $mp3s = Mango::Document::GridFile->new(
        parent => 'CDDB::Track',
        config => { multiple => 1 }
    );
...
Mango::Document::GridFile represents a MongoDB gridfs reference document
and is designed to be assigned to attributes in a parent document class.
Mango::Document::GridFile provides a standardized API for handling
...
keyword provided by L<Mango::Document::Sugar>.
...
configuration in the config attribute.
    ...
    my $mp3s = Mango::Document::Relative->new(
        ..., config => {  }
    );
