# ABSTRACT: A Relationship Wrapper Around Mango Relational Documents

use strict;
use warnings;

package Mango::Document::Relative;
{
    $Mango::Document::Relative::VERSION = '0.001_01';
}
...
Mango::Document::Relative - A Relationship Wrapper Around Mango Relational Documents
...
=head1 SYNOPSIS
    ...
    my $tracks = Mango::Document::Relative->new(
        parent => 'CDDB::Album',
        target => 'CDDB::Track',
        config => { multiple => 1 }
    );
...
Mango::Document::Relative represents a MongoDB relational/reference document
and is designed to be assigned to attributes in a parent document class.
Mango::Document::Relative provides a standardized API for handling
...
"has_many", and "belongs_to" keywords provided by L<Mango::Document::Sugar>.

The purpose of using this and other relationship identification/wrapper classes
is that it provides the Mango serialization/deserialization mechanisms with a
standard API.
