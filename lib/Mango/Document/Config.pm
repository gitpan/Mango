# ABSTRACT: Configuration for a Mango Document Class

use strict;
use warnings;

package Mango::Document::Config;
{
    $Mango::Document::Config::VERSION = '0.001_01';
}
...
Mango::Document::Config - Configuration for a Mango Document Class
...
Mango::Document::Config is a trait attached to the Mango configuration
...
key() keyword. Learn more about the key() keyword at L<Mango::Document::Sugar>.
...
L<Mango::Document::Sugar>. Access the indexes attribute directly as follows:
...
L<Mango::Document::Sugar>. Access the searches attribute directly as follows:
