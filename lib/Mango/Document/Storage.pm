# ABSTRACT: Mango Document Storage Interface

use strict;
use warnings;

package Mango::Document::Storage;
{
    $Mango::Document::Storage::VERSION = '0.001_01';
}
...
Mango::Document::Storage - Mango Document Storage Interface
...
Mango::Document::Storage is a role that provides database-specific
functionality to your Mango document classes.
