# ABSTRACT: A Relationship Wrapper Around Mango Embedded Documents

use strict;
use warnings;

package Mango::Document::Child;
{
    $Mango::Document::Child::VERSION = '0.001_01';
}
...
Mango::Document::Child - A Relationship Wrapper Around Mango Embedded Documents
...
=head1 SYNOPSIS
    ...
    my $tracks = Mango::Document::Child->new(
        parent => 'CDDB::Album',
        target => 'CDDB::Track',
        config => { multiple => 1 }
    );
...
Mango::Document::Child represents a MongoDB child document and is designed to 
be assigned to attributes in a parent document class. Mango::Document::Child
