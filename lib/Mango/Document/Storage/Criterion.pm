# ABSTRACT: Mango Chainable Collection Query Builder

use strict;
use warnings;

package Mango::Document::Storage::Criterion;
{
    $Mango::Document::Storage::Criterion::VERSION = '0.001_01';
}
use Mango::Document::Storage::Cursor;
...
sub query {
    ...
    return Mango::Document::Storage::Cursor->new(
        cursor      => $mongo_cursor,
...
Mango::Document::Storage::Criterion - Mango Chainable Collection Query Builder
...
=head1 SYNOPSIS
    ...
    my $search = Mango::Document::Storage::Criterion->new(
...
Mango::Document::Storage::Criterion provides Mango with a chainable object
